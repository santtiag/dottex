...
const es = {
  ...
  viewCode: "Código",
  viewVisual: "Visual",
  preambleLines: "Preámbulo — {0} líneas",
  references: "Referencias",

  // Barra de herramientas LaTeX (Código y Visual)
  tbUndo: "Deshacer",
  tbRedo: "Rehacer",
  tbBold: "Negrita",
  tbItalic: "Cursiva",
  tbUnderline: "Subrayado",
  tbHeadings: "Encabezado",
  tbSection: "Sección",
  tbSubsection: "Subsección",
  tbSubsubsection: "Subsubsección",
  tbBullets: "Lista con viñetas",
  tbNumbered: "Lista numerada",
  tbMath: "Insertar fórmula",
  tbMathInline: "Fórmula en línea",
  tbMathDisplay: "Fórmula en bloque",
  tbMathEq: "Ecuación numerada",
  tbMathFrac: "Fracción",
  tbMathSqrt: "Raíz",
  tbMathPow: "Potencia",
  tbMathSub: "Subíndice",
...
const en: typeof es = {
  ...
  viewCode: "Code",
  viewVisual: "Visual",
  preambleLines: "Preamble — {0} lines",
  ...
  tbHeadings: "Heading",
  tbSection: "Section",
  tbSubsection: "Subsection",
  tbSubsubsection: "Subsubsection",
  tbBullets: "Bulleted list",
  tbNumbered: "Numbered list",
  tbMath: "Insert formula",
  tbMathInline: "Inline formula",
  tbMathDisplay: "Display formula",
  tbMathEq: "Numbered equation",
  tbMathFrac: "Fraction",
  tbMathSqrt: "Square root",
  tbMathPow: "Power",
  tbMathSub: "Subscript",
  tbMathSum: "Sum",
  tbMathInt: "Integral",
